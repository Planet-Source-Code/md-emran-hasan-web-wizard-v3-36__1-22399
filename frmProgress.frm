...
frmMain.rtbText.SaveFile "C:\Temp\tmp.001"
Call Status(25, 50, "Setting up page header...")
Call LoadText(frmMain.txtTemp, "C:\Temp\tmp.001")
...
Call FileSave(frmMain.txtFinal.Text, "C:\Temp\tempDoc.htm")
End If
End Sub
...
Unload Me
Else
Call ShellExecute(&O0, vbNullString, "C:\Temp\tempDoc.htm", vbNullString, vbNullString, vbNormalFocus)
Unload Me
End If
End Sub
